...
class apiController {
 // static String localhost = '10.0.2.2';
  static String localhost = '192.168.0.100';
...
/*// Example usage
  void fetchData() async {
    try {
      List<Map<String, dynamic>> voters = await getAllVoters();
      print(voters);
    } catch (e) {
      print('Error: $e');
    }
...
/*// Example usage
  void fetchData() async {
    try {
      List<Map<String, dynamic>> candidates = await getAllCandidates();
      print(candidates);
    } catch (e) {
      print('Error: $e');
    }
...
/*// Example usage
  void fetchData() async {
    try {
      List<Map<String, dynamic>> admins = await getAllAdmins();
      print(admins);
    } catch (e) {
      print('Error: $e');
    }
